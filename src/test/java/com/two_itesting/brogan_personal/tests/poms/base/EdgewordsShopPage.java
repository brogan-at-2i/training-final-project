package com.two_itesting.brogan_personal.tests.poms.base;
 ...
 */
public abstract class EdgewordsShopPage<T extends EdgewordsShopPage<T>> {
    ...
    public EdgewordsShopPage(WebDriver driver, WebDriverWait wait, String url, boolean navigateTo, boolean subpage) {
        this.driver = driver;
        this.wait = wait;
        this.url = url;
        if (navigateTo) {
